...
public class Launcher extends Application {
    ...
    public static void setUneqiupItem() {
        Launcher.setEquippedWeapon(null);
        Launcher.setEquippedArmor(null);
        Launcher.setAllEquipments(GenItemList.setUpItemList());
        BasedCharacter unequipAllEquipments = getMainCharacter();
        unequipAllEquipments.unequipWeapon();
        unequipAllEquipments.unequipArmor();
